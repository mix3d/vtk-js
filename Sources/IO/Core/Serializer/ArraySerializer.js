...
function vtkArraSerializer(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkArraSerializer');
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  vtkArraSerializer(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkArraSerializer');
